...
?>
	...
	<fieldset>
		...
		<div class="row">
			<div class="col-lg-5">
				<?php echo $form->field($model,'no_elevators')->textInput(array('maxlength'=>128,'class'=>'tipster','title'=>'Wie viele Lastenaufzüge gibt es vor Ort?')); ?>
				<?php echo $form->field($model,'no_parking')->textInput(array('maxlength'=>128,'class'=>'tipster','title'=>'Wie viele Kundenparkplätze gibt es vor Ort?')); ?>
			</div>
			<div class="col-lg-7">				
				<?php echo $form->field($model,'room_height')->textInput(array('maxlength'=>128,'class'=>'tipster','title'=>'Welche Höhe haben die Abteile im Schnitt')); ?>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-5">
				<?php echo $form->field($model,'max_degrees')->textInput(array('maxlength'=>10,'class'=>'tipster','title'=>'Wie hoch ist die max. Temperatur die in den Räumen erreicht wird?')); ?>
			</div>
			<div class="col-lg-7">				
				<?php echo $form->field($model,'min_degrees')->textInput(array('maxlength'=>128,'class'=>'tipster','title'=>'Wie niedrig ist die min. Temperatur die in den Räumen erreicht wird?')); ?>				
			</div>
		</div>
		<div class="row">
			<div class="col-lg-5">
